...
if __name__ == '__main__':
    bag = MyBunch()
    test_connection(bag)
    # sql1="""insert into lead_conv1_test values ('2019-07-11', 
    #     '2019-07-11 00:00:00', 'lead123456', 
    #     '{"request_type":"lead_conv1"}', 
    #     '{"request_type":"lead_conv1"}')"""
    # sql1 = "amma"+sql1
    # err_str = do_sql(bag, sql=sql1,stop_on_error=False)
    df,err_str = do_query(bag, sql="select count(1) from lead_conv1_test",stop_on_error=False)
    print(">>>>> df=",df)
